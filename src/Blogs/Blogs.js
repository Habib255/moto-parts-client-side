    ...
    return (
        <div className=' grid grid-cols-1 lg:grid-cols-2 justify-center gap-6 items-center'>
            < div class="card  bg-base-100 shadow-xl" >
                <div class="card-body">
                    <h2 class="card-title"> <span className='font-bold text-slate-200'>Question: How will you improve the performance of a React Application?</span></h2>
            ...
            < div class="card bg-base-100 shadow-xl" >
                <div class="card-body">
                    <h2 class="card-title"> <span className='font-bold text-slate-200'>Question: What are the different ways to manage a state in a React application?
            ...
            < div class="card bg-base-100 shadow-xl" >
                <div class="card-body">
                    <h2 class="card-title font-bold text-slate-200"> Question: Why you do not set the state directly in React. For example, if you have const[products, setProducts] = useState([]). Why you do not <br /> set products = [...] instead,  you use the setProducts</h2>
